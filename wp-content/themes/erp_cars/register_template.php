	...
	<div class="container">
    	<div class="row">
            ...
            <div class="col-12 col-sm-12 col-lg-6 col-xl-6">
                ...
                <p>Relax. 365 TRANS INC. collects, clears through customs and delivers millions of shipments.</p>
            </div>
             <div class="col-12 col-sm-12 col-lg-6 col-xl-6">
            	<h3>EASE OF USE</h3>
             ...
             <div class="col-12 col-sm-12 col-lg-6 col-xl-6">
                ...
                <p>Your shipment stays with 365 TRANS INC. from door-to-door giving you security and peace of mind.</p>
            </div>
             <div class="col-12 col-sm-12 col-lg-6 col-xl-6">
